...
<Modal bind:show={show} name="Spruch erfassen">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <form
                ...
                >
                    ...
                    <div
                        class="form__group"
                        class:form__group--nickname={showNicknameError}
                    >
                        <label
                            class="form__label form__label--dark"
                            for="nickname">Autor / Nickname</label
                        >
                        ...
                        <input
                            ...
                            required
                            bind:value={nickname}
                            on:keyup={debounce(() => checkNickname(), 250)}
                        />
                        <p class="form__hint"></p>
                        {#if showNicknameError && nickname}
                            <p class="form__error">
                                Verwende keine beleidigenden Wörter
                            </p>
                        {/if}
                    </div>
                    <div class="row">
                        <div class="col-12 col-s-6">
                            <div class="form__group">
                                <label
                                    class="form__label form__label--dark form__label--no-mb"
